...
public OnMapStart()
{
    ...
    {
        // Creamos un temporizador de 22 segundos para ejecutar el comando
        CreateTimer(22.0, Timer_ExecuteCommand, _, TIMER_FLAG_NO_MAPCHANGE);
        
        // Creamos otro temporizador de 25 segundos para cambiar el cvar
...
// Temporizador que cambia el cvar después de 25 segundos
